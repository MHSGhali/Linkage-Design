# Linkage Design — the manual

Everything the program does, in detail. If you only want to get it running,
the [README](../README.md) is enough; nothing here has to be read first,
because `H` lists every key inside the window.
