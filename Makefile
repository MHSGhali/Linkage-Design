...
SRC     := src/main.c src/mechanism.c src/solver.c src/linalg.c src/render.c src/export.c src/ui.c src/cam.c
OBJ     := $(SRC:.c=.o)
HDRS    := $(wildcard src/*.h)
BIN     := linkage_design

TEST_SRC := tests/test_mechanism.c src/mechanism.c src/solver.c src/linalg.c src/export.c src/ui.c src/cam.c
